...
build/thesis.pdf: build/Hubb_Ham_Zeit_Besetzung.pdf build/Hubb_Strom.pdf build/Ham2e_Strom.pdf build/Hubb_eplot.pdf build/Hubb_ediff_plot.pdf build/Hubb_gzv_plot.pdf build/Hubb_gze_plot.pdf build/Hubb_Grenz_Plot.pdf build/Hubb_diff.pdf
