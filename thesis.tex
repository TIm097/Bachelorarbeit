...
\author{Timo Gräßer}
\title{Inverser Faraday-Effekt in Mottisolatoren}
\date{2017}
...
\input{content/02_theoretische_grundlagen.tex}
\input{content/03_festkoerper_modelle.tex}
\input{content/04_isolatoren.tex}
\input{content/05_inverser_faraday_effekt.tex}
\input{content/06_ergebnisse.tex}
